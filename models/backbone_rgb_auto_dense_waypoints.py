...
class Backbone(nn.Module):
    ...
    def forward(self, img, joints, sentence, phis, stage=0):
        ...
        if stage == 1:
            return target_position_pred, ee_pos_pred, attn_map, attn_map2, attn_map3
        ...
        trajectory = self.controller(state_embedding4[:, 4, :])
        trajectory = trajectory.reshape(img.shape[0], self.num_traces_out, self.num_weight_points)

        return target_position_pred, ee_pos_pred, attn_map, attn_map2, attn_map3, attn_map4, trajectory
