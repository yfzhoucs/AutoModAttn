...
from models.backbone_rgb_auto import Backbone
from utils.load_data_rgb_abs_action_auto import DMPDatasetEERandTarXYLang, pad_collate_xy_lang
...
def main(writer, name, batch_size=96):
    ...
    dataset_test = DMPDatasetEERandTarXYLang(val_data_dirs, random=True, length_total=120)
    ...
    data_loader_train_dmp = torch.utils.data.DataLoader(dataset_train_dmp, batch_size=batch_size,
                                          shuffle=True, num_workers=8,
                                          collate_fn=pad_collate_xy_lang)
    dataset_test_dmp = DMPDatasetEERandTarXYLang(val_data_dirs, random=False, length_total=120)
...
if __name__ == '__main__':
    name = 'train-abs-action-auto-1200'
