...
from utils.load_data_rgb_abs_action_auto_pick_lid import DMPDatasetEERandTarXYLang, pad_collate_xy_lang
...
def main(writer, name, batch_size=32):
    ...
    # load data
    data_dirs = [train_set_path]
    val_data_dirs = [val_set_path]
